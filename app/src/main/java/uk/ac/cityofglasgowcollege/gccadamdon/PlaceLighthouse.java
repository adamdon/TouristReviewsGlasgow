...
public class PlaceLighthouse extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_place_lighthouse);
    }
    ...
    {
        Intent myIntent = new Intent(PlaceLighthouse.this, HomeOne.class);
    ...
    {
        Intent myIntent = new Intent(PlaceLighthouse.this, Places.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(PlaceLighthouse.this, Settings.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(PlaceLighthouse.this, Review.class);
        startActivity(myIntent);
    }
