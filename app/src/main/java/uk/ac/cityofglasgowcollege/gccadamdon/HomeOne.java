...
public class HomeOne extends AppCompatActivity {
    ...
    {
        Intent myIntent = new Intent(HomeOne.this, HomeOne.class);
    ...
    {
        Intent myIntent = new Intent(HomeOne.this, Places.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeOne.this, Settings.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeOne.this, HomeTwo.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeOne.this, HomeThree.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeOne.this, HomeFour.class);
        startActivity(myIntent);
    }
