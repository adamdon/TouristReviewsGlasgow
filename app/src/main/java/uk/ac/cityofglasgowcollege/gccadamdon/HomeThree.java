...
public class HomeThree extends AppCompatActivity {
    ...
    {
        Intent myIntent = new Intent(HomeThree.this, HomeOne.class);
    ...
    {
        Intent myIntent = new Intent(HomeThree.this, Places.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeThree.this, Settings.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeThree.this, HomeTwo.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeThree.this, HomeThree.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(HomeThree.this, HomeFour.class);
        startActivity(myIntent);
    }
