...
public class PlaceBuchanan extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_place_buchanan);
    }
    ...
    {
        Intent myIntent = new Intent(PlaceBuchanan.this, HomeOne.class);
    ...
    {
        Intent myIntent = new Intent(PlaceBuchanan.this, Places.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(PlaceBuchanan.this, Settings.class);
        startActivity(myIntent);
    }
    ...
    {
        Intent myIntent = new Intent(PlaceBuchanan.this, Review.class);
        startActivity(myIntent);
    }
